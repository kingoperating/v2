...
PUT Function - appends entire table with dataframe given serverName, databaseName, and tableName from king-arc1
...
"""
SQL script that deletes duplicate records from a table given serverName, databaseName, and tableName from king-arc1
